define("jquery/daterangepicker/1.3.22/daterangepicker-debug", [ "gallery/moment/2.9.0/moment-debug", "jquery/jquery/2.1.0/jquery-debug" ], function(require, exports, module) {
    /**
   * @version: 1.3.22
   ...
   */
    (function(root, factory) {
        if (typeof define === "function" && define.amd) {
            ...
            var momentjs = require("gallery/moment/2.9.0/moment-debug");
            var jQuery;
            try {
                jQuery = require("jquery/jquery/2.1.0/jquery-debug");
            } catch (err) {
        ...
        var DateRangePicker = function(element, options, cb) {
            ...
            var DRPTemplate = '<div class="daterangepicker dropdown-menu">' + '<div class="calendar first left"></div>' + '<div class="calendar second right"></div>' + '<div class="ranges">' + '<div class="range_inputs">' + '<div class="daterangepicker_start_input">' + '<label for="daterangepicker_start"></label>' + '<input class="input-mini" type="text" name="daterangepicker_start" value="" />' + "</div>" + '<div class="daterangepicker_end_input">' + '<label for="daterangepicker_end"></label>' + '<input class="input-mini" type="text" name="daterangepicker_end" value="" />' + "</div>" + '<button class="applyBtn" disabled="disabled" type="button"></button>' + '<button class="cancelBtn" type="button"></button>' + "</div>" + "</div>" + "</div>";
            //custom options
        ...
        DateRangePicker.prototype = {
            ...
            setOptions: function(options, callback) {
                ...
                if (typeof options.autoApply === "boolean") {
                    ...
                    if (this.autoApply) this.container.find(".applyBtn, .cancelBtn").addClass("hide");
                }
