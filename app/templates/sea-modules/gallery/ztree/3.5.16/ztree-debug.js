define("gallery/ztree/3.5.16/ztree-debug", [ "$-debug" ], function(require, exports, module) {
    ...
    (function($) {
        ...
        handler = {
            ...
            onClickNode: function(event, node) {
                var setting = data.getSetting(event.data.treeId), clickFlag = setting.view.autoCancelSelected && (event.ctrlKey || event.metaKey) && data.isSelectedNode(setting, node) ? 0 : setting.view.autoCancelSelected && (event.ctrlKey || event.metaKey) && setting.view.selectedMulti ? 2 : 1;
