...
function WordFilter(editor) {
	...
	editor.on('BeforePastePreProcess', function(e) {
		...
		if (isWordContent(e.content)) {
			...
			tinymce.each(schema.elements, function(rule) {
			...
			var domParser = new tinymce.html.DomParser({}, schema);
			...
			e.content = new tinymce.html.Serializer({}, schema).serialize(rootNode);
		}
	});
}
