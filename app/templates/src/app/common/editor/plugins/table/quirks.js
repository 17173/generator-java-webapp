  ...
  function moveWebKitSelection() {
    function eventHandler(e) {
      ...
      function isVerticalMovement() {
        return key == tinymce.util.VK.UP || key == tinymce.util.VK.DOWN;
      }
      ...
      function findColumn(rowElement, columnIndex) {
        ...
        tinymce.each(rowElement.children, function(cell, i) {
      ...
      if (isVerticalMovement() && isInTable(editor)) {
        ...
        setTimeout(function() {
          if (shouldFixCaret(preBrowserNode)) {
            handle(!e.shiftKey && key === tinymce.util.VK.UP, preBrowserNode, e);
          }
        }, 0);
      }
    }
